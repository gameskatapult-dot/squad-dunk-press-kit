...
describe('XML Parser', () => {
  const companyXML = fs.readFileSync(`${process.cwd()}/docs/_official_example_data/data.xml`, 'utf-8')
  const productXML = fs.readFileSync(`${process.cwd()}/docs/_official_example_data/product/data.xml`, 'utf-8')
